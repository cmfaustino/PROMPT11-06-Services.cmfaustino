...
namespace FirstSOAPservice.MStranslatorSoapServiceReference {
    ...
    public partial class GetTranslationsResponse : object, System.Runtime.Serialization.IExtensibleDataObject, System.ComponentModel.INotifyPropertyChanged {
        ...
        [System.Runtime.Serialization.OptionalFieldAttribute()]
        private FirstSOAPservice.MStranslatorSoapServiceReference.TranslationMatch[] TranslationsField;
        ...
        [System.Runtime.Serialization.DataMemberAttribute(EmitDefaultValue=false)]
        public FirstSOAPservice.MStranslatorSoapServiceReference.TranslationMatch[] Translations {
            get {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://api.microsofttranslator.com/V2", ConfigurationName="MStranslatorSoapServiceReference.LanguageService")]
    public interface LanguageService {
        ...
        FirstSOAPservice.MStranslatorSoapServiceReference.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, FirstSOAPservice.MStranslatorSoapServiceReference.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/AddTranslationArrayResponse" +
            "")]
        void AddTranslationArray(string appId, FirstSOAPservice.MStranslatorSoapServiceReference.Translation[] translations, string from, string to, FirstSOAPservice.MStranslatorSoapServiceReference.TranslateOptions options);
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArray", ReplyAction="http://api.microsofttranslator.com/V2/LanguageService/GetTranslationsArrayRespons" +
            "e")]
        FirstSOAPservice.MStranslatorSoapServiceReference.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, FirstSOAPservice.MStranslatorSoapServiceReference.TranslateOptions options);
        ...
        FirstSOAPservice.MStranslatorSoapServiceReference.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, FirstSOAPservice.MStranslatorSoapServiceReference.TranslateOptions options);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LanguageServiceChannel : FirstSOAPservice.MStranslatorSoapServiceReference.LanguageService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LanguageServiceClient : System.ServiceModel.ClientBase<FirstSOAPservice.MStranslatorSoapServiceReference.LanguageService>, FirstSOAPservice.MStranslatorSoapServiceReference.LanguageService {
        ...
        public FirstSOAPservice.MStranslatorSoapServiceReference.GetTranslationsResponse GetTranslations(string appId, string text, string from, string to, int maxTranslations, FirstSOAPservice.MStranslatorSoapServiceReference.TranslateOptions options) {
        ...
        public void AddTranslationArray(string appId, FirstSOAPservice.MStranslatorSoapServiceReference.Translation[] translations, string from, string to, FirstSOAPservice.MStranslatorSoapServiceReference.TranslateOptions options) {
            base.Channel.AddTranslationArray(appId, translations, from, to, options);
        }
        
        public FirstSOAPservice.MStranslatorSoapServiceReference.GetTranslationsResponse[] GetTranslationsArray(string appId, string[] texts, string from, string to, int maxTranslations, FirstSOAPservice.MStranslatorSoapServiceReference.TranslateOptions options) {
        ...
        public FirstSOAPservice.MStranslatorSoapServiceReference.TranslateArrayResponse[] TranslateArray(string appId, string[] texts, string from, string to, FirstSOAPservice.MStranslatorSoapServiceReference.TranslateOptions options) {
